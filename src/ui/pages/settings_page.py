...
class SettingsPage:
    ...
    def create(self):
        ...
        settings_title.setStyleSheet(
            f"color: {THEME['text_secondary']}; font-weight: 600; margin-bottom: 8px;"
        )
    ...
    def _create_appearance_tab(self):
        ...
        appearance_header.setStyleSheet(
            f"color: {THEME['text_primary']}; font-weight: 600; margin-bottom: 8px;"
        )
    ...
    def _create_keyboard_shortcuts_tab(self):
        ...
        shortcuts_header.setStyleSheet(
            f"color: {THEME['text_primary']}; font-weight: 600; margin-bottom: 8px;"
        )
        ...
        info_label = QLabel(
            "Learn the keyboard shortcuts to navigate Watchdog quickly and efficiently."
        )
