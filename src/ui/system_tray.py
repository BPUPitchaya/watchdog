...
from PyQt6.QtWidgets import QCheckBox, QLabel, QMenu, QSystemTrayIcon, QVBoxLayout, QWidget
...
class SystemTrayIcon(QSystemTrayIcon):
    ...
    def set_monitoring_active(self, active: bool):
        ...
        if self.notifications_enabled:
            self.show_notification("WATCHDOG", f"Monitoring {'started' if active else 'stopped'}")
