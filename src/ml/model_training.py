...
def generate_synthetic_data(n_samples=10000):
    ...
    data['protocol_type'] = np.random.choice([0, 1, 2], n_samples, p=[0.8, 0.15, 0.05])  # tcp, udp, icmp
    ...
    print(f"Class distribution: Normal={np.sum(labels=='normal')}, Attack={np.sum(labels=='attack')}")
