...
class NetworkTopologyPage:
    ...
    def create(self):
        ...
        self.scan_status.setStyleSheet(
            f"color: {THEME['success']}; font-family: {THEME['font_mono']}; font-size: 12px;"
        )
        ...
        self.pc_count_label.setStyleSheet(
            f"color: {THEME['primary']}; font-family: {THEME['font_mono']}; font-size: 14px;"
        )
        stats_layout.addWidget(self.pc_count_label)

        self.iot_count_label = QLabel("Mobile/IoT: 0")
        self.iot_count_label.setStyleSheet(
            f"color: {THEME['warning']}; font-family: {THEME['font_mono']}; font-size: 14px;"
        )
        stats_layout.addWidget(self.iot_count_label)

        self.unknown_count_label = QLabel("Unknown: 0")
        self.unknown_count_label.setStyleSheet(
            f"color: {THEME['danger']}; font-family: {THEME['font_mono']}; font-size: 14px;"
        )
        ...
        device_list_widget.setStyleSheet("background-color: transparent;")
        ...
        device_list_header.setStyleSheet(
            f"color: {THEME['primary']}; font-family: {THEME['font_mono']}; font-size: 16px; margin-bottom: 10px;"
        )
        ...
        details_header.setStyleSheet(
            f"color: {THEME['primary']}; font-family: {THEME['font_mono']}; font-size: 16px; margin-top: 20px; margin-bottom: 10px;"
        )
        ...
        """)
        self.device_details.setPlaceholderText(
    ...
    def scan_network_devices(self):
        ...
        self.scan_status.setStyleSheet(
            "color: #FFD93D; font-family: 'Courier New', monospace; font-size: 12px;"
        )
    ...
    def _perform_direct_scan(self):
        ...
        try:
            ...
            self.scan_status.setText(f"Found {len(devices)} devices")
            self.scan_status.setStyleSheet(
                "color: #6BCF7F; font-family: 'Courier New', monospace; font-size: 12px;"
            )
    ...
    def _show_scan_error(self, error_message):
        ...
        self.scan_status.setStyleSheet(
            "color: #FF6B6B; font-family: 'Courier New', monospace; font-size: 12px;"
        )
        self.scan_btn.setEnabled(True)
