...
class ErrorMessages:
    ...
    @classmethod
    def get_message(
        cls, error_type: str, category: str = "NETWORK_ERRORS"
...
class ErrorDialog(QDialog):
    ...
    def __init__(self, title: str, message: str, solution: str, details: str = "", parent=None):
...
class ErrorHandler:
    ...
    def show_error_dialog(self, title: str, message: str, solution: str, details: str = "") -> None:
