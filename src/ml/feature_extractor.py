...
class FeatureExtractor:
    ...
    def _get_default_features(self):
        ...
        return {
            'src_bytes': 0, 'dst_bytes': 0, 'count': 0, 'protocol_type': 0,
            'service': 0, 'flag': 9, 'serror_rate': 0, 'srv_serror_rate': 0,
            'rerror_rate': 0, 'same_srv_rate': 0, 'diff_srv_rate': 0,
            'srv_count': 0, 'dst_host_count': 0, 'dst_host_srv_count': 0,
