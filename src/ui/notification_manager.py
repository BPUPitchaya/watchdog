...
class NotificationManager(QObject):
    ...
    def add_notification(self, title: str, message: str,
                        notification_type: str = NotificationType.INFO,
                        priority: str = NotificationPriority.MEDIUM) -> None:
    ...
    def add_threat_alert(self, threat_type: str, source_ip: str, 
                        details: str = '') -> None:
...
class NotificationWidget(QWidget):
    ...
    def refresh_notifications(self):
        ...
        for notification in reversed(notifications):
            ...
            text += f"<span style='color: #6B7280; font-size: 11px;'>{notification.timestamp}</span>"
